                                                                ...
                                                                <div class="progression-studios-elementor-review-container">
                                                                    ...
                                                                    <div class="progression-masonry-margins">
                                                                        <div id="progression-video-index-masonry-a282bc6" style="position: relative; height: 1225.5px;">
                                                                            ...
                                                                            <? $subcategoria = $audio->getSubcategoriaPrincipal() ?>
                                                                                            ...
                                                                                            <div class="progression-studios-video-index-container">
                                                                                                <a href="{{ $audio->getUrl() }}">
                                                                                                    <div class="progression-studios-video-feaured-image">
                                                                                                        <img src="{{ $audio->thumbnail }}" class="attachment-progression-studios-video-index size-progression-studios-video-index wp-post-image" alt="">
                                                                                                    </div>
                                                                                                        ...
                                                                                                        <div class="progression-video-index-table">
                                                                                                            <div class="progression-video-index-vertical-align">
                                                                                                                ...
                                                                                                                @if($audio->autores->count())
                                                                                                                    <p>{{ Helper::getList($audio->autores) }}</p>
                                                                                                                @endif
                                                                                                                
                                                                                                                <h2 class="progression-video-title"><b>{{ $audio->titulo }}</b></h2>
                                                                                                                <div class="clearfix"></div>
                                                                                                                <!--@if($audio->eventos->count())
                                                                                                                    <p>
                                                                                                                    @foreach($audio->eventos as $evento)
                                                                                                                        <?=$evento->nombre?>
                                                                                                                    @endforeach
                                                                                                                    </p>
                                                                                                                @endif-->
{{--                                                                                                                <ul class="video-index-meta-taxonomy ma-tags-container">--}}
{{--                                                                                                                    <li>Magdalena Fernández</li>--}}
{{--                                                                                                                    <li>Ecos</li>--}}
{{--                                                                                                                </ul>--}}
                                                                                                                <div class="clearfix-pro"></div>
                                                                                                            </div>
