...
<!--Elizabeth-->
<script src="{{ asset('js/panelNota/phoenix.js') }}"></script>
...
<!--Elizabeth-->
<script src="{{ asset('js/panelNota/ecommerce-dashboard.js') }}"></script>
...
<!--Elizabeth-->
<script src="{{ asset('js/panelNota/custom.js') }}"></script>
