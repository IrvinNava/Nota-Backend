        ...
        <header class="ma-background relative nav-sticky">
            <div class="container-fluid text-white">
                <div class="row p-t-b-10 ">
                    <div class="col">
                        <h4><i class="icon icon-library_books text-lime s-18"></i>&nbsp;<span>EDITAR GALERIA</span></h4>
                    </div>
                </div>
            </div>
        </header>
                        ...
                        <div class="card">
                            <div class="card-body white">
                                ...
                                <form id="form-registro">
                                    ...
                                    <input type="hidden" id="id_nucleo" name="id_nucleo" value="<?= $exposicionDigital->id_nucleo ?>">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="texto-select-fecha-evento">Año</label>
                                                        <input id="galeria-input-anio" name="anio" type="text" class="form-control" value="<?= $exposicionDigital->anio ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="texto-select-fecha-evento">Soporte</label>
                                                        <input id="galeria-input-anio" name="soporte" type="text" class="form-control" value="<?= $exposicionDigital->soporte ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="texto-select-fecha-evento">Medidas</label>
                                                        <input id="galeria-input-documento" name="medidas" type="text" class="form-control" value="<?= $exposicionDigital->medidas ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mt-1">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="galeria-input-subtitulo">Especificaciones</label>
                                                        <div class="input-group mb-2 custom-select-2-container">
                                                            <input id="galeria-input-subtitulo" name="especificaciones" type="text" class="form-control required" value="<?= $exposicionDigital->especificaciones ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="texto-select-fecha-evento">Ubicación</label>
                                                        <input id="galeria-input-documento" name="ubicacion" type="text" class="form-control" value="<?= $exposicionDigital->ubicacion ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="galeria-input-subtitulo">Achivo</label>
                                                <div class="input-group mb-2 custom-select-2-container">
                                                    <input id="galeria-input-subtitulo" name="archivo" type="text" class="form-control required" value="<?= $exposicionDigital->archivo ?>">
                                                </div>
                                            </div>
                                        </div>
