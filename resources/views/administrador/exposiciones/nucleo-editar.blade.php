        ...
        <header class="ma-background relative nav-sticky">
            <div class="container-fluid text-white">
                <div class="row p-t-b-10 ">
                    <div class="col">
                        <h4><i class="icon icon-library_books text-lime s-18"></i>&nbsp;<span>EDITAR NUCLEO</span></h4>
                    </div>
                </div>
            </div>
        </header>
                    ...
                    <div class="col-md-6 col-lg-7 p-0">
                        <div class="card">
                            <div class="card-body white">
                                <h4 class="mb-3"><b>Datos del núcleo</b></h4>
                                <form id="form-registro">
                                    <input type="hidden" id="registro-input-id" name="id" value="<?= $exposicionDigital->id ?>">
                                    <input type="hidden" id="id_exposicion" name="id_exposicion" value="<?= $exposicionDigital->id_exposicion ?>">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <hr>
                                            <label for="registro-input-titulo" style="display: none">Logos</label>
                                            <div class="gallery-container hidden" style="display: none">
                                                <div class="row">
