        ...
        <header class="ma-background relative nav-sticky">
            <div class="container-fluid text-white">
                <div class="row p-t-b-10 ">
                    <div class="col">
                        <h4><i class="icon icon-add_box text-lime s-18"></i>&nbsp;<span>AGREGAR SLIDER</span></h4>
                    </div>
                </div>
            </div>
        </header>
                ...
                <div class="row no-gutters">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-2 custom-select-2-container">
                                                    <input id="slider-input-titulo" name="titulo" type="text" class="form-control required" value="">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="texto-select-subcategorias">Subtitulo</label>
                                                            <input id="slider-input-subtitulo" name="subtitulo" type="text" class="form-control required" value="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="slider-fecha-inicio" name="fecha_inicio" type="text" class="form-control input-datetimepicker" value="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="slider-fecha-fin">Fecha Fin</label>
                                                        <input id="slider-fecha-fin" name="fecha_fin" type="text" class="form-control input-datetimepicker" value="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="slider-input-link" name="link" type="text" class="form-control required" value="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    ...
                                                    <div class="material-switch float-right">
                                                        <input id="slider-swich-visibilidad" name="visibilidad" type="checkbox" value="1">
                    ...
                    <div class="col-md-6 col-lg-5 relative p-0">
                        <div class="card-header white d-flex justify-content-between ">
                            <h6><i class="icon icon-mode_edit"></i> IMÁGENES DEL SLIDER</h6>
                        </div>
...
<div class="editor-tools-container d-flex justify-content-center align-items-center">
    <div class="save-update-content-container">
        <div class="d-flex justify-content-between">
            <a href="javascript:void(0)" id="btn-actualizar-slider" class="btn btn-success btn-sm">
