        ...
        <header class="ma-background relative nav-sticky">
            <div class="container-fluid text-white">
                <div class="row p-t-b-10 ">
                    <div class="col">
                        <h4><i class="icon icon-mode_edit text-lime s-18"></i>&nbsp;<span>EDITAR PLAYLIST</span></h4>
                    </div>
                </div>
            </div>
        </header>
                        ...
                        <div class="card">
                            <div class="card-body white">
                                ...
                                <form id="form-registro">
                                    <input type="hidden" id="playlist-input-id" name="id" value="{{$playlist->id}}">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="registro-input-titulo">Título</label>
                                                <div class="input-group mb-2 custom-select-2-container">
                                                    <input id="playlist-input-titulo" name="titulo" type="text" class="form-control required" value="{{$playlist->titulo}}">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="texto-select-subcategorias">Subtitulo</label>
                                                            <input id="playlist-input-subtitulo" name="subtitulo" type="text" class="form-control required" value="{{$playlist->subtitulo}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="descripcion_corta" rows="4" class="form-control">{{$playlist->descripcion_corta}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="descripcion_larga" rows="8" class="form-control">{{$playlist->descripcion_larga}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    ...
                                                    <div class="material-switch float-right">
                                                        <input id="playlist-swich-visibilidad" name="visibilidad" type="checkbox" value="{{$playlist->status}}" @if($playlist->status) checked @endif>
                                                        <label for="playlist-swich-visibilidad" id="label-swich-visibilidad" class="bg-primary"></label>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <form id="form-registro-cover">
                                            ...
                                            <div class="cover-img-container">
                                                @if(!empty($playlist->cover))
                                                    <img src="{{ $playlist->cover }}" data-mime="image/png">
                                                    <input type="hidden" name="cover" value="{{ $playlist->cover }}">
                                                @else
                                            ...
                                            <div class="thumbnail-img-container">
                                                @if(!empty($playlist->thumbnail))
                                                    <img src="{{ $playlist->thumbnail }}" data-mime="image/png">
...
<div class="editor-tools-container d-flex justify-content-center align-items-center">
    <div class="save-update-content-container">
        <div class="d-flex justify-content-between">
            <small><strong>Última actualización:</strong><br>{{Carbon::parse($playlist->updated_at)->format('H:i d/m/Y'),}}</small>
            <a href="javascript:void(0)" id="btn-actualizar-playlist" class="btn btn-success btn-sm">
