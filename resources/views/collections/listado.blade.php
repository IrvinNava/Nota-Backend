                ...
                <div class="mt-3">
                    <div class="row g-3 mb-4 justify-content-between">
                        ...
                        <div class="col-auto">
                            ...
                            <a class="btn btn-primary" href="{{ url('/add-collection') }}"><span class="fas fa-plus me-2"></span>Add collection</a>
                        </div>
                    </div>
                                ...
                                <table class="table table-s fs--1 mb-0 align-middle table-hover dataTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="{{ url('/collectionDetail') }}">Hispanic heritage month</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ url('/collectionDetail') }}">Black history month</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ url('/collectionDetail') }}">Pride month</a></td>
                                            <td><span class="me-1 mb-1 fs--2" data-feather="box"></span>10 experiences</td>
                                            <td><span class="badge badge-phoenix fs--2 badge-phoenix-success"><span class="badge-label">Active</span></span></td>
                                            <td class="btn-reveal-trigger">
                                                <div class="font-sans-serif btn-reveal-trigger position-static">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ url('/collectionDetail') }}">DEI Elementals</a></td>
                                            <td><span class="me-1 mb-1 fs--2" data-feather="box"></span>10 experiences</td>
                                            <td><span class="badge badge-phoenix fs--2 badge-phoenix-success"><span class="badge-label">Active</span></span></td>
                                            <td class="btn-reveal-trigger">
                                                <div class="font-sans-serif btn-reveal-trigger position-static">
