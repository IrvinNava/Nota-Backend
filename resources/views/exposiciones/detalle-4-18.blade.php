        ...
        <div class="width-container-pro pt-3">
            ...
            <div class="ma-row">
                <div class="col-md-6 text-center">
                    <a data-fancybox="gallery" href="{{asset('img/exposiciones/2/nucleo-4/18/a.JPG')}}">
                        <img src="{{asset('img/exposiciones/2/nucleo-4/18/a.JPG')}}" alt="">
                    </a>
                </div>
                <div class="col-md-6">
                        ...
                        <div class="col-md-10 col-md-offset-1 p-0">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Tinta Ferrogálica, mineral y vegetal
                                    </td>
                                </tr>
                                <tr>
                                    <td><b>Ubicación</b></td>
                                    <td>
                                        <span>AGMP. Patronatos, vol. 1, foja 1 f.</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td><b>Archivo</b></td>
                            ...
                            <div class="exhibition-description-p" align="justify">
                                <p>Un libro de patronatos contiene los santos venerados y acordados por los ayuntamientos para protección de las ciudades. Refleja también las devociones que los vecinos veneraban de acuerdo con el gremio al que pertenecían. El libro de patronatos de 1769 fue escrito por Antonio Basilio de Arteaga y Solórzano, regidor decano del ayuntamiento; sin embargo, se trata de un ejemplar muy valioso que tiene anexa una carta firmada por Arteaga y Solórzano donde se pide lealtad de Puebla al rey Carlos III e incluye las transcripciones de las reales cédulas, privilegios y fueros concedidos por Carlos I y Felipe II a Puebla a lo largo del siglo XVI.</p>
                                <p>Las cinco páginas que se exhiben tratan de la carta escrita y firmada por Arteaga y Solórzano. Tiene metáforas donde el rey Carlos III aparece representado como el “sol”, ya que los dominios de la monarquía española se extendían por Europa, América y Asia. Carlos III envió a Nueva España a José de Gálvez como visitador para supervisar a los ayuntamientos y la recaudación de impuestos. Este libro de patronatos incluye las transcripciones a petición del visitador Gálvez. Para 1769, resultaba incomprensible la letra del siglo XVI, una razón más que motivó dicha transcripción.</p>
                            </div>
        ...
        <div class="width-container-pro">
            ...
            <div class="row exposition-gallery-container">
                <div class="grid-item col-md-3 mb-3">
                    <a data-fancybox="gallery" href="{{asset('img/exposiciones/2/nucleo-4/18/b.JPG')}}">
                        <div class="exhibition-gallery-item" style="background-image: url({{asset('img/exposiciones/2/nucleo-4/18/b.JPG')}});"></div>
                    </a>
                </div>
                <div class="grid-item col-md-3 mb-3">
                    <a data-fancybox="gallery" href="{{asset('img/exposiciones/2/nucleo-4/18/c.JPG')}}">
                        <div class="exhibition-gallery-item" style="background-image: url({{asset('img/exposiciones/2/nucleo-4/18/c.JPG')}});"></div>
                    </a>
                    <div class="clearfix"></div>
                </div>
                <div class="grid-item col-md-3 mb-3">
                    <a data-fancybox="gallery" href="{{asset('img/exposiciones/2/nucleo-4/18/d.JPG')}}">
                        <div class="exhibition-gallery-item" style="background-image: url({{asset('img/exposiciones/2/nucleo-4/18/d.JPG')}});"></div>
                    </a>
                    <div class="clearfix"></div>
                </div>
                <div class="grid-item col-md-3 mb-3">
                    <a data-fancybox="gallery" href="{{asset('img/exposiciones/2/nucleo-4/18/e.JPG')}}">
                        <div class="exhibition-gallery-item" style="background-image: url({{asset('img/exposiciones/2/nucleo-4/18/e.JPG')}});"></div>
                    </a>
                </div>
            </div>
