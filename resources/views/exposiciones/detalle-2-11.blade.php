            ...
            <div class="col-xs12">
                <ul class="Breadcrumbs__list contemporaneo-breadcrumbs">
                    ...
                    <li class="Breadcrumbs__list__item is-current">
                        Real título y colación de la doctrina de Santa María de Jesús Acapetlahuacan
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="width-container-pro pt-3">
            ...
            <div class="ma-row">
                <div class="col-md-6 text-center">
                    <a data-fancybox="gallery" href="{{asset('img/exposiciones/2/nucleo-2/foto-11.jpg')}}">
                        <img src="{{asset('img/exposiciones/2/nucleo-2/foto-11.jpg')}}" alt="">
                    </a>
                </div>
                <div class="col-md-6">
                    <div class="ma_ficha_tecnica">
                        <div class="col-md-10 col-md-offset-1 p-0">
                            ...
                            <table>
                                <tr>
                                    <td><b>Título</b></td>
                                    <td>Real título y colación de la doctrina de Santa María de Jesús Acapetlahuacan</td>
                                </tr>
                                <tr>
                                    <td><b>Fecha</b></td>
                                    <td>
                            ...
                            <div class="exhibition-description-p" align="justify">
                                <p>Desde la década de 1640 se inició en Puebla un proceso de secularización, es decir, las fundaciones de órdenes religiosas pasaron a manos de clérigos diocesanos. Tales medidas buscaron reforzar la autoridad de la Corona a través de los obispos. Con la llegada de los reyes Borbón al trono hispánico, después de 1714, dicha política se intensificó, ya que buscaron tener poder central y absoluto en sus territorios.</p>
                                <p>Un ejemplo de las tempranas políticas eclesiásticas borbónicas se halla en la cédula de 1728, aquí exhibida. El documento cita las bulas papales que confirman a Felipe V, primer rey Borbón, como cabeza de la Iglesia americana y exige a los obispos mayor control sobre las fundaciones dentro de sus jurisdicciones. La doctrina de Santa María de Jesús Acapetlahuacan, ubicada en el actual municipio de Atlixco, comenzó a llamar la atención de los clérigos que se interesaron en arrebatarla a los franciscanos.</p>
                            </div>
