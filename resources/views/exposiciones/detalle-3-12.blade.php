            ...
            <div class="col-xs12">
                <ul class="Breadcrumbs__list contemporaneo-breadcrumbs">
                    ...
                    <li class="Breadcrumbs__list__item is-current">
                        Don Gaspar de Zúñiga y Acevedo, conde de Monterrey...
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="width-container-pro pt-3">
            ...
            <div class="ma-row">
                <div class="col-md-6 text-center">
                    <a data-fancybox="gallery" href="{{asset('img/exposiciones/2/nucleo-3/foto-12.jpg')}}">
                        <img src="{{asset('img/exposiciones/2/nucleo-3/foto-12.jpg')}}" alt="">
                    </a>
                </div>
                <div class="col-md-6">
                    <div class="ma_ficha_tecnica">
                        <div class="col-md-10 col-md-offset-1 p-0">
                            ...
                            <table>
                                <tr>
                                    <td><b>Título</b></td>
                                    <td>Don Gaspar de Zúñiga y Acevedo, conde de Monterrey, por parte de don Diego Romano, obispo de Tlaxcala, y de acuerdo con una real cédula librada en Barcelona en relación con las licencias de los religiosos al erigir conventos</td>
                                </tr>
                                <tr>
                                    <td><b>Fecha</b></td>
                                    <td>
                            ...
                            <div class="exhibition-description-p" align="justify">
                                <p>Los franciscanos tuvieron un papel protagónico en la evangelización y reorganización administrativa en la región de Tlaxcala-Puebla entre las décadas de 1520 y 1590. En este período fundaron importantes conventos como el de Tlaxcala, Huejotzingo, Cholula, Calpan, Huaquechula, Ocotelulco y Puebla. Hacia 1596, el obispo Diego Romano pidió al virrey Gaspar de Zúñiga y Acevedo, conde de Monterrey, su intercesión para frenar nuevos monasterios, iglesias, ermitas y traslados de cualquier orden. Este hecho demuestra la autonomía que tenía el clero regular frente a la autoridad episcopal.</p>
                                <p>El Archivo Diocesano resguarda el documento que emitió el virrey atendiendo a la demanda del obispo y donde apela a una real cédula expedida por Felipe II en 1585, donde limitaba la construcción de nuevos conventos mendicantes y así respaldar a Romano. El manuscrito corrobora el interés del virrey por reforzar el gobierno central novohispano y el poder de los obispos.</p>
                            </div>
