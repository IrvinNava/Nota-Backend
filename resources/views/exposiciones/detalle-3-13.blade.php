            ...
            <div class="col-xs12">
                <ul class="Breadcrumbs__list contemporaneo-breadcrumbs">
                    ...
                    <li class="Breadcrumbs__list__item is-current">
                        Testimonios de la fundación de la casa de niños expósitos...
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="width-container-pro pt-3">
            ...
            <div class="ma-row">
                <div class="col-md-6 text-center">
                    <a data-fancybox="gallery" href="{{asset('img/exposiciones/2/nucleo-3/foto-13.jpg')}}">
                        <img src="{{asset('img/exposiciones/2/nucleo-3/foto-13.jpg')}}" alt="">
                    </a>
                </div>
                <div class="col-md-6">
                    <div class="ma_ficha_tecnica">
                        <div class="col-md-10 col-md-offset-1 p-0">
                            ...
                            <table>
                                <tr>
                                    <td><b>Título</b></td>
                                    <td>Testimonios de la fundación de la casa de niños expósitos de San Cristóbal de la Ciudad de los Ángeles</td>
                                </tr>
                                <tr>
                                    <td><b>Fecha</b></td>
                                    <td>
                            ...
                            <div class="exhibition-description-p" align="justify">
                                <p>Puebla experimentó un crecimiento urbano a inicios del siglo XVII. Como responsables de la organización social, los obispos autorizaron la fundación de conventos, hospitales, hospicios y otras instituciones de caridad para el bienestar de sus habitantes.</p>
                                <p>En 1607, las órdenes religiosas consolidaron su autoridad; sin embargo, los clérigos diocesanos aún no lo lograban y tuvieron conflictos con los frailes. En ese contexto, los obispos fundaron hospicios y otras instituciones de caridad que beneficiaron a los habitantes de las ciudades, pero también demostraban su naciente poder ante las órdenes religiosas.</p>
                                <p>Los testimonios dan cuenta de la intención de Cristóbal de Rivera, cura de Tlacotepec, a fundar una casa de recién nacidos abandonados o “expósitos”. Comunicó su proyecto al obispo angelopolitano Diego Romano quien apoyó la iniciativa junto con su hermana María de Rivera, quedando los tres como los primeros patronos de dicha casa. El edificio del claustro que se conserva hoy día data de fines del siglo XVII cuando se reunieron los recursos monetarios. Actualmente, el inmueble sigue en pie en la calle 4 Norte, pero es sede de una escuela primaria llamada Himno Nacional.</p>
                            </div>
